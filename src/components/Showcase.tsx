          ...
          <div key={slide.id}>
            ...
            >
              ...
              <div className="flex flex-col items-center md:items-start text-center md:text-left w-full md:max-w-[68%] z-10 justify-center">
                ...
                <h1 className="font-family text-[#3d3d3d] font-semibold text-[28px] sm:text-[50px] xl:text-[70px] leading-[110%] uppercase">
                  {slide.title}
                  <span className="flex flex-row text-[#46A358] font-semibold">
                    {slide.highlight}
                  </span>
                </h1>

                <p className="text-[#727272] text-[12px] sm:text-[14px] w-[95%] md:w-[80%] mb-4 md:mb-6 leading-5 sm:leading-6 font-normal">
                  {slide.description}
                </p>
        ...
        {slides.map((_, index) => (
          <span
            ...
            className={`w-[10px] h-[10px] rounded-full transition-all duration-300 ${
              activeSlide === index ? "bg-[#46A358]" : "bg-[#3d3d3d] opacity-30"
            }`}
          />
        ))}
      </div>
