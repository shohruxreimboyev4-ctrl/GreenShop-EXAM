  ...
  return (
    <div className="w-[90%] max-w-[1400px] m-auto mt-10 mb-20">
      <div className="mb-6 flex items-center gap-2">
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 px-4 py-2 rounded-md border border-[#46A358] text-[#46A358] hover:bg-[#46A358] hover:text-white transition-colors font-medium"
        >
          <svg
            width="18"
            height="18"
